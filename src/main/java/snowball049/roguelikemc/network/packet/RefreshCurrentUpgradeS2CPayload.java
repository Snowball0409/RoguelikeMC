...
public record RefreshCurrentUpgradeS2CPayload(List<RoguelikeMCUpgradeDataProvider.RoguelikeMCUpgrade> upgrades) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, RefreshCurrentUpgradeS2CPayload> CODEC = PacketCodec.tuple(PacketCodecs.registryCodec(RoguelikeMCUpgradeDataProvider.RoguelikeMCUpgrade.CODEC.listOf()), RefreshCurrentUpgradeS2CPayload::upgrades, RefreshCurrentUpgradeS2CPayload::new);
