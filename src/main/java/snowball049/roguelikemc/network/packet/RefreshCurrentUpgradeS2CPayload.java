...
public record RefreshCurrentUpgradeS2CPayload(List<RoguelikeMCConfig.RogueLikeMCUpgradeConfig> upgrades) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, RefreshCurrentUpgradeS2CPayload> CODEC = PacketCodec.tuple(PacketCodecs.registryCodec(RoguelikeMCConfig.RogueLikeMCUpgradeConfig.CODEC.listOf()), RefreshCurrentUpgradeS2CPayload::upgrades, RefreshCurrentUpgradeS2CPayload::new);
