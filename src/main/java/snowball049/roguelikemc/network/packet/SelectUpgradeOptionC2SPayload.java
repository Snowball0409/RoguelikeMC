...
public record SelectUpgradeOptionC2SPayload(RoguelikeMCConfig.RogueLikeMCUpgradeConfig option) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SelectUpgradeOptionC2SPayload> CODEC = PacketCodec.tuple(RoguelikeMCConfig.RogueLikeMCUpgradeConfig.PACKET_CODEC, SelectUpgradeOptionC2SPayload::option, SelectUpgradeOptionC2SPayload::new);
