...
public record SelectUpgradeOptionC2SPayload(RoguelikeMCUpgradesConfig.RogueLikeMCUpgradeConfig option) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SelectUpgradeOptionC2SPayload> CODEC = PacketCodec.tuple(RoguelikeMCUpgradesConfig.RogueLikeMCUpgradeConfig.PACKET_CODEC, SelectUpgradeOptionC2SPayload::option, SelectUpgradeOptionC2SPayload::new);
